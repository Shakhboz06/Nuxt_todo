      ...
      <div class="headers">
        ...
        <div class="subheading">
          ...
          <p
            class="table"
            @click="Change_table()"
            :class="{ tabWhite: isBlue }"
          >
            Таблица
          </p>
          <p class="tile" @click="Change_view()" :class="{ tabBlue: isBlue }">
            Плитка
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div class="task_block_2">
              ...
              <p
                class="Check_Up"
                :class="{
                  isRed: item.check == 'Не выполнено',
                  isBlue: item.check == 'В прогрессе',
                }"
              >
                {{ item.check }}
              </p>
...
export default {
  ...
  methods: {
    HideBar: function () {
      (this.isActive = false), (this.bgActive = false);
      this.isItem = false;
    },
    AddTask: function () {
      (this.isActive = true), (this.bgActive = true);
      this.isItem = true;
    },
